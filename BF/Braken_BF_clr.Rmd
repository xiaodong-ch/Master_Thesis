...
saveRDS(iphy, "Braken&BF_clr-2021-12-14.rds")
```
...
write_csv(all_adonis, "adonis_BF_clr-2021-12-14.csv")
write_csv(list_beta_df, "betadispersion_BF_clr-2021-12-14.csv")
```
...
```{r message=FALSE, warning=FALSE, include=FALSE}
all_adonis <- read_csv("adonis_BF_clr-2021-12-14.csv")
list_beta_df <- read_csv("betadispersion_BF_clr-2021-12-14.csv")
iphy <- read_rds("Braken&BF_clr-2021-12-14.rds")
```
...
write_csv(sig_adonis, "sig_adonis_BF_clr-2021-12-14.csv")
```
