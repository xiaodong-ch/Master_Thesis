...
#saveRDS(iphy, "Braken_hum&BVs-2021-11-01.rds")
```
...
write_csv(all_adonis, "adonis_backgound_padjusted-2021-12-01.csv")
write_csv(list_beta_df, "betadispersion_padjusted-2021-12-01.csv")
```
...
all_adonis <- read_csv("adonis_backgound_padjusted-2021-12-01.csv")
list_beta_df <- read_csv("betadispersion_padjusted-2021-12-01.csv")
...
write_csv(sig_adonis, "sig_adonis_padjusted-2021-12-01.csv")
```
