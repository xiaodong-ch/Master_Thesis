...
This note book will have an overview of Technical variable

File names   --variable number (include the family_ID)
vocabulary.xlsx  --18
WGS_technicalVariables_baby_20.10.21.csv  --17
WGS_technicalVariables_parents_20.10.21.csv  --16
...
baby_techvariable <- read_csv("WGS_technicalVariables_baby_20.10.21.csv", guess_max = 9000)
#parent_techvariable <- read_csv("WGS_technicalVariables_parents_20.10.21.csv", guess_max = 9000)
#WGS data
...
sample <- braken_infant_sample %>% left_join(baby_techvariable, by = "sample_ID") %>% 
...
saveRDS(iphy, "Braken&Technique-2021-11-09.rds")
```
...
write_csv(all_adonis, "adonis_technical-2021-11-09.csv")
write_csv(list_beta_df, "betadispersion_technical-2021-11-09.csv")
```
...
```{r message=FALSE, warning=FALSE, include=FALSE}
all_adonis <- read_csv("adonis_technical-2021-11-09.csv")
list_beta_df <- read_csv("betadispersion_technical-2021-11-09.csv")
iphy <- read_rds("Braken&Technique-2021-11-09.rds")
```
...
write_csv(sig_adonis, "sig_adonis_technical-2021-11-09.csv")
```
